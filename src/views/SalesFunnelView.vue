    ...
    series: [
      {
        ...
        emphasis: {
          ...
          itemStyle: {
            areaColor: '#1E5AA8',
            shadowBlur: 10,
            shadowColor: 'rgba(30, 90, 168, 0.5)'
          }
        },
        data: mapData
      }
...
.map-section::before {
  ...
  right: 0;
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(30, 90, 168, 0.6), transparent);
  z-index: 2;
}
...
.map-container::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(30, 90, 168, 0.05), rgba(135, 206, 235, 0.05));
  z-index: -1;
}
