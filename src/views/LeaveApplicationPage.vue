          ...
          >
            ...
            <el-form-item label="附件">
              ...
              >
                ...
                <template #tip>
                  <div class="el-upload__tip">支持上传诊断证明、请假单等材料，单个文件不超过50MB</div>
                </template>
              </el-upload>
            </el-form-item>
...
import { addLeaveApplication, getEmployees, uploadAttachmentFiles, getLeaveApplications, resubmitLeave } from '../services/api'
    ...
    if (valid) {
      ...
      try {
        ...
        const response = editId
          ? await resubmitLeave(editId, data)
          : await addLeaveApplication(data)
        if (response.success) {
          ElMessage.success(editId ? '重新提交成功' : '请假申请已提交')
